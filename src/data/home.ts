export const homeContent = {
  hero: {
    eyebrow: "Australian human omics digital infrastructure",
    intro:
    ...
    secondaryCta: {
      label: "See partner contributions",
      href: "/partners-contributions",
    },
  },
  why: {
    eyebrow: "Addressing a critical need",
  ...
  partners: {
    ...
    link: {
      label: "Browse partner contributions",
      href: "/partners-contributions",
    },
  },
  nextStep: {
    ...
    intro:
      "Start with the services and resources catalogue, or use the contact page if you need help finding the right pathway.",
    primaryCta: {
      label: "Explore services & resources",
      href: "/services-resources",
    },
    secondaryCta: {
      label: "Contact the GUARDIANS team",
      href: "/contact",
    },
  },
};
