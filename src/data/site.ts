export const site = {
  title: "GUARDIANS",
  description:
    "A national partnership building secure, interoperable infrastructure for discovering, responsibly accessing, and analysing sensitive human omics data.",
  contactEmail: "contact@biocommons.org.au",
